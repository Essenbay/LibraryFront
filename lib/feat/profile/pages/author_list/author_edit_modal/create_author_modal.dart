...
void showCreateAuthorModal(BuildContext context) async {
    ...
    builder: (BuildContext conE) {
      return IntrinsicHeight(
        ...
        child: Padding(
            ...
            child: const _CreateAuthorModal()),
      ));
    },
  );
  if (result == true) {
                ...
                ElevatedButton(
                    onPressed: () {
                      if (_surname.text.isEmpty || _name.text.isEmpty) {
                        ...
                        contex.read<AuthorEditBloc>().add(AuthorEvent.create(
